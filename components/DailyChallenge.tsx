      ...
      <div className="max-w-2xl mx-auto mt-4 bg-white dark:bg-black p-6 rounded-2xl shadow-xl border border-slate-200 dark:border-emerald-500 text-center relative min-h-[80vh] overflow-hidden">
          ...
          {calculatingPercentage && (
              <div className="flex flex-col items-center justify-center py-12 relative z-10">
                  <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-purple-600 dark:border-emerald-500 mb-4"></div>
          ...
          {!showPercentage && finalPercentage === null && !calculatingPercentage && (
              <>
                  <div className="w-16 h-16 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-600 dark:text-yellow-400 rounded-full flex items-center justify-center mx-auto mb-4 text-3xl animate-bounce border-2 dark:border-yellow-500">
                      {isPreviewMode ? '👁️' : '🏆'}
                  </div>
                  <h2 className="text-2xl font-bold text-slate-800 dark:text-emerald-400 mb-2">
                  ...
                  <div className="bg-slate-50 dark:bg-gray-900/50 p-4 rounded-xl border border-slate-200 dark:border-emerald-500/30 mb-4 relative z-10">
                      ...
                      <div className="text-3xl font-black text-purple-600 dark:text-emerald-400">{completedCount} <span className="text-lg text-slate-400 dark:text-slate-500 font-medium">/ {playlist.length}</span></div>
                      ...
                      {!isPreviewMode && finalPercentage !== null && !showPercentage && (
                          <div className="mt-3 pt-3 border-t border-slate-200 dark:border-emerald-500/30">
                              <div className="text-xs text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wider mb-1">
                                  Végeredmény
                              </div>
                              <div className={`text-2xl font-bold ${
                                  finalPercentage >= 80 ? 'text-green-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'
                              }`}>
                                  {finalPercentage}%
                              </div>
                  ...
                  {!isPreviewMode && (
                      <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-500 rounded-lg p-3 mb-4 relative z-10">
                  ...
                  {!isPreviewMode && (
                      <div className="mb-4">
                          <button 
                              ...
                              className="w-full bg-yellow-100 dark:bg-yellow-900/30 hover:bg-yellow-200 dark:hover:bg-yellow-900/50 text-yellow-800 dark:text-yellow-400 py-2 px-3 rounded-xl font-bold border border-yellow-300 dark:border-yellow-500 transition-colors flex items-center justify-center gap-2 text-sm relative z-10"
                          >
                              <span className="text-lg">🏆</span>
                              {showLeaderboard ? 'Ranglista elrejtése' : 'Ranglista megtekintése'}
                          ...
                          {showLeaderboard && (
                              <div className="mt-3 bg-white dark:bg-gray-900/50 border border-slate-200 dark:border-emerald-500/30 rounded-xl p-3 max-h-48 overflow-y-auto relative z-10">
                          <h3 className="text-sm font-bold text-slate-800 dark:text-emerald-400 mb-3 text-center flex items-center justify-center gap-2">
                              <span className="text-base">🏆</span>
                              Ranglista
                          </h3>
